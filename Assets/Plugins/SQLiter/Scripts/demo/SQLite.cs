    ...
    public class SQLite : MonoBehaviour
    {
        ...
        void Test()
        {
           ...
           /// InsertPlayer("Frank", 3, 2, 3, 2, 4, 12);
            InsertPlayer("Drika", 3, 2, 3, 2, 4, 12);
        }
        ...
        /// Table name and DB actual file location
        /// </summary>
        private const string SQL_DB_NAME = "MySkillsDB";
        ...
        void Start()
        {
            ...
            dbconn = (IDbConnection)new SqliteConnection(SQL_DB_LOCATION);
            ...
            string sqlQuery = "SELECT id, text " + "FROM tasks";
